...
<%
    if (current_user == null) {
        ...
        if (current_user.getUserType().equals("normal")) {
...
<div class="container admin mt-3">
    ...
    <div class="row mt-3">
        <!-- //first column -->
        <div class="col-md-4">
            <a href="list_user.jsp" style="text-decoration: none; color: black;"
        ...
        <!-- //second column -->
        <div class="col-md-4">
            <a href="list_category.jsp" style="text-decoration: none; color: black;"
               onmouseover="this.style.textDecoration='none'" onmouseout="this.style.textDecoration='none'">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="container">
        ...
        <!-- //third column  -->
        <div class="col-md-4">
            <a href="list_product.jsp" style="text-decoration: none; color: black;"
               onmouseover="this.style.textDecoration='none'" onmouseout="this.style.textDecoration='none'">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="container">
                ...
                <form action="ProductOperationServlet" method="post"
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control"
                               placeholder="Price of the product" name="pPrice" required max="999999999"/>
                    </div>

                    <div class="form-group">
                        <input type="number" class="form-control"
                               placeholder="Enter product discount" name="pDiscount" min="0" max="100"/>
                    </div>
